...
## Change in emission factors over the phase
...
anim_save("animations/bp_eff_ph.gif", animation = last_animation())
```

![](animations/bp_eff_ph.gif){fig-align="center" width="60%"}
...
bp_eff_time <- moveplot(bp2_wood,time.var = "time", group.var = "Wood", move=TRUE, hulls=FALSE,
         scale.var = 20, shadow = TRUE)
anim_save("animations/bp_eff_tim.gif", animation = last_animation())
```

![](animations/bp_eff_tim.gif){fig-align="center" width="60%"}
...
-   [github.com/jthomasmock/arrow-dplyr](github.com/jthomasmock/arrow-dplyr) - slide inspiration
